...
from .selfhost_analysis import SelfhostAnalysisV1, parse_selfhost_analysis_v1, selfhost_analysis_v1_to_json
...
def parse_selfhost_pipeline_bundle_v1(bundle_raw: object) -> SelfhostPipelineBundleV1:
    ...
    raw_analysis = _bundle_value_to_raw(bundle.get("analysis"))
    ...
    return json.dumps(
        {
            ...
            "analysis": json.loads(selfhost_analysis_v1_to_json(bundle.analysis)),
